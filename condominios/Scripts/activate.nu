...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\javie\Documents\Desarrollo\Django\API-condominios\condominios'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\javie\Documents\Desarrollo\Django\API-condominios\condominios\Scripts\deactivate.nu'
